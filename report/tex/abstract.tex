...
A priority queue appears in various multi-threading applications.
...
We evaluated the difference between those platforms, and we also compared the lock-free implementation with different baseline implementations, e.g. Intel TBB concurrent priority queue.
