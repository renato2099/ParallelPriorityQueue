...
\subsection{Cache-invalidation assessment}
...
%All the cores from the Xeon Phi seems to guarantee a fixed bandwidth for each of its hardware cores, such that we can scale the number of threads up without being limited by the memory bandwidth.\\
