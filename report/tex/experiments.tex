...
\begin{itemize}
	...
	\item very readable, attractive plots (do 1 column, not 2 column plots for this class), proper readable font size. An example is below (of course you can have a different style),
	\item every plot answers a question, which you pose and extract the answer from the plot in its discussion
\end{itemize}
...
\begin{itemize}
	...
	\item Xeon Phi results
		\begin{itemize}
			...
			\item Mix workload
		\end{itemize}
	\item Explanation on why we are not foot
\end{itemize}
